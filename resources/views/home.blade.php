                  ...
                  <ul class="solid-bullet-list">
                    <li>
                      ...
                      <div class="image-layers">
                        ...
                        <img class="img-sm rounded-circle image-layer-item" src="{{asset('/admin')}}/images/faces/face3.jpg" alt="profile"/>
                        <img class="img-sm rounded-circle image-layer-item" src="{{asset('/admin')}}/images/faces/face5.jpg" alt="profile"/>
                        <img class="img-sm rounded-circle image-layer-item" src="{{asset('/admin')}}/images/faces/face8.jpg" alt="profile"/>
                      </div>
                    </li>
                    <li>
                    ...
                    <table class="table">
                      <tbody>
                        <tr>
                          ...
                          <td class="py-1">
                            <img src="{{asset('/admin')}}/images/faces/face13.jpg" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="py-1">
                            <img src="{{asset('/admin')}}/images/faces/face2.jpg" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                          <td class="font-weight-bold">
                            Mae Saunders
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="py-1">
                            <img src="{{asset('/admin')}}/images/faces/face11.html" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                          <td class="font-weight-bold">
                            Marguerite Phillips
                          </td>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          <td class="py-1">
                            <img src="{{asset('/admin')}}/images/faces/face1.jpg" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                          <td>
                            South Shyanne
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="{{asset('/admin')}}/images/faces/face3.jpg" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                          <td>
                            East Helga
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="{{asset('/admin')}}/images/faces/face4.jpg" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                          <td>
                            Omerbury
                          </td>
